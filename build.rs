...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    // Avoid using -Bsymbolic on Linux; it can cause relocation/link errors with Rust cdylibs
    // when LLVM internal/hidden symbols are referenced across units. See issue context.
